        ...
        <div class="card border border-info">
                ...
                <form class="p-4" method="POST" action="editarProceso.php">
                    <div class="mb3">
                        ...
                        <input type="text" class="form-control" name="txtCedula" required value="<?php echo $usuario->Cedula?>">
                    </div>
                    <div class="mb3">
                    ...
                    <div class="mb3">
                        ...
                        <input type="text" class="form-control" name="txtTelefono" required value="<?php echo $usuario->Telefono?>">
                    </div>
                    <div class="mb3">
                        <label class="form-label">Correo:</label>
                        <input type="text" class="form-control" name="txtCorreo" required value="<?php echo $usuario->Correo?>">
                    </div>
                    <div class="mb3">
