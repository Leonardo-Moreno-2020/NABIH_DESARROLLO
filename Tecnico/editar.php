        ...
        <div class="card border border-info">
                ...
                <form class="p-4" method="POST" action="editarProceso.php">
                    <div class="mb3">
                        ...
                        <input type="text" class="form-control" name="txtCedula" required value="<?php echo $tecnico->Cedula?>">
                    </div>
                    <div class="mb3">
                    ...
                    <div class="mb3">
                        ...
                        <input type="text" class="form-control" name="txtTelefono" required value="<?php echo $tecnico->Telefono?>">
                    </div>
                    <div class="mb3">
                        <label class="form-label">Correo:</label>
                        <input type="text" class="form-control" name="txtCorreo" required value="<?php echo $tecnico->Correo?>">
                    </div>
                    <div class="mb3">
                        <label class="form-label">Profesion:</label>
                        <input type="text" class="form-control" name="txtProfesion" required value="<?php echo $tecnico->Profesion?>">
                    </div>
                    <div class="mb3">
